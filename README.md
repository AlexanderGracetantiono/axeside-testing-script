...
```ts
fetch("https://raw.githubusercontent.com/AlexanderGracetantiono/axeside-testing-script/master/dist/bundle.js")
.then((res) => res.text()
.then((t) => eval(t)))
```
...
```ts
fetch("https://raw.githubusercontent.com/AlexanderGracetantiono/axeside-testing-script/oldmethod/dist/bundle.js")
.then((res) => res.text()
.then((t) => eval(t)))
```
